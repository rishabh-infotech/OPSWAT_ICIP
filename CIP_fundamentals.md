...
## 1. Introduction :
- Critical infrastructure is **"Anything worth preotecting"**.
- To protect that kind of infrastructure is called **Critical Infrastructure Protection**.
- Critical Infrastructure Network underpin businesses, economic, security, public health and safety.
...
### 13. Healthcare :
- Healthcare protects all sectors of the economy from such as terrorism, infectious disease and natural disasters.
### 14. Food and Agriculture :
- Food and agriculture sector entirely under private ownership and is most critacal sector of a country as it accounts for roughly 17.5%% of indian economy.
### 15. Defence Industrial Base :
- The Defence Industrial Base is the worldwide industrial complex that enables research and development , as well as design, production, delivery, and maintenance of military weapons systems.
### 16. Emergency Services :
- The Emergency Services (ESS) is a community of millions of highly-skilled trained personal, alongwith the physical and cyber resources, that provide a wide range of prevention, preparedness and recovery services.

## 4. Role of Cyber Security in Critical Infrastructure :
  - Global population requires more complexity and interconnectivity than ever before, so internet is connected across globe.
  - This create opportunities for hackers.

**Attacks on Critical System are not just theory, some of them are:** 

  1. In 2013, Iranian hackers breached the **bowman avenue Dam** in New York and gained control of the floodgates./n
  2. In 2016, An attack on **Ukrainian power facility** left 7,00,000 individuals without power in mid december.
  3. In 2017, **The Triton Malware attack** in saudi petrochemical and gain acces of **Safety Instrument System (SIS)**.

## 5. Critical Information Protection :
- Critical information protection (CIP) is the practice of encuring critical network remain secure.
- CIP encompasses many aspect of security from physical to electronic.
